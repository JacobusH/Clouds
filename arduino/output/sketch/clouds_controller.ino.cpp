#line 1 "e:\\Projects\\clouds\\arduino\\clouds_controller\\clouds_controller.ino"
#line 1 "e:\\Projects\\clouds\\arduino\\clouds_controller\\clouds_controller.ino"
/*********************************************************************
...
void loop()
{
  sendResponse("Loop Outside IF");
  
  // Echo received data
  if ( Bluefruit.connected() && bleuart.notifyEnabled() )
  {
    int command = bleuart.read();
    sendResponse("Loop Inside IF | command: " + command.ToString());
