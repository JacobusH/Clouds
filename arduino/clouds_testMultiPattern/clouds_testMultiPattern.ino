...
NeoPatterns Ring1(16, 16, NEO_GRB + NEO_KHZ800, &Ring1Complete);
NeoPatterns Ring2(16, 27, NEO_GRB + NEO_KHZ800, &Ring2Complete);
...
//    Stick.begin();
    ...
    Ring1.setBrightness(35);
    Ring2.setBrightness(35);
